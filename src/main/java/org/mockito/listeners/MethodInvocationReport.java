 ...
 *
 * <p>Contains the information on the mock, the location of the stub the return value if it returned
 * something (maybe null), or an exception if one was thrown when the method was invoked.
 */

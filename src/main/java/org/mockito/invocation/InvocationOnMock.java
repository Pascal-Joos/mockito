...
public interface InvocationOnMock extends Serializable {
   ...
   *
   * <p>This method is preferred over {@link #getArgument(int, Class)} for readability. Please read
   * the documentation of {@link #getArgument(int, Class)} for an overview of situations when that
   * method is preferred over this one.
   *

...
public class ArgumentMatchers {
     ...
     * @return <code>null</code>.
     */
    @NullUnmarked public static <T> T eq(T value) {
        reportMatcher(new Equals(value));
     ...
     * @return <code>null</code>.
     */
    @NullUnmarked public static <T> T refEq(T value, String... excludeFields) {
     ...
     * @return <code>null</code>.
     */
    @NullUnmarked public static <T> T same(T value) {
     ...
     * @see #isNotNull(Class)
     */
    @NullUnmarked public static <T> T isNull() {
     ...
     * @return <code>null</code>.
     */
    @NullUnmarked public static <T> T notNull() {
     ...
     * @return <code>null</code>.
     */
    @NullUnmarked public static <T> T argThat(ArgumentMatcher<T> matcher) {

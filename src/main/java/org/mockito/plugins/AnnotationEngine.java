 ...
 *
 * <p>Mockito default engine handles the logic behind &#064;Mock, &#064;Captor, &#064;Spy and
 * &#064;InjectMocks annotations.
 *
 * <p>This interface is an extension point that make possible to use a different annotation engine
 * allowing to extend or replace mockito default engine.
 *
 * <p>If you are interested then see implementations or source code of {@link
 * org.mockito.MockitoAnnotations#openMocks(Object)}
 *

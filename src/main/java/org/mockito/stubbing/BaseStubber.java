...
/**
 * Base interface for stubbing consecutive method calls with {@link Mockito#doReturn(Object)}
 * syntax. This interface is needed so that we can reuse the same hierarchy in subinterfaces.
 *
 * @since 2.20.0
 */
@NotExtensible
public interface BaseStubber {
   ...
   *
   * <p>See javadoc for {@link Mockito#doReturn(Object)}
   *
   ...
   * Use it for stubbing consecutive calls in {@link Mockito#doReturn(Object)} style.
   *
   * <p>See javadoc for {@link Mockito#doReturn(Object, Object...)}
   *
   * @param toBeReturned to be returned when the stubbed method is called
   ...
   *
   * <p>See javadoc for {@link Mockito#doCallRealMethod()}
   *
   * @return stubber - to select a method for stubbing
   */

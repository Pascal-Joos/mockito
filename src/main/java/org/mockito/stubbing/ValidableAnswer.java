...
public interface ValidableAnswer {
   ...
   *
   * <p>The implementation must throw an MockitoException to indicate that this answer is not valid
   * for the given invocation. If the validation succeed the implementation must simply return
   * without throwing.
   *

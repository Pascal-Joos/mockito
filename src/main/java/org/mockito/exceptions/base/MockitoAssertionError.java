...
/**
 * Base class for verification errors emitted by Mockito. Verification errors are triggered by
 * "verify" methods, for example {@link org.mockito.Mockito#verify(Object)} or {@link
 * org.mockito.Mockito#verifyNoMoreInteractions(Object...)}. All error classes that inherit from
 * this class will have the stack trace filtered. Filtering removes Mockito internal stack trace
 * elements to provide clean stack traces and improve productivity.
 *
 ...
 *
 * <p>Advanced users and framework integrators can control stack trace filtering behavior via {@link
 * org.mockito.plugins.StackTraceCleanerProvider} classpath plugin.
 */

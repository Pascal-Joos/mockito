...
/**
 * Raised by mockito to emit an error either due to Mockito, or due to the User. All exception
 * classes that inherit from this class will have the stack trace filtered. Filtering removes

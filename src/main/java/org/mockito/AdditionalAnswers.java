...
public class AdditionalAnswers {
   ...
   * </code></pre>
   *
   * Mockito will return the vararg array if the first argument is a vararg in the method and if the
   * return type has the same type as the vararg array.
   *
   * <pre class="code"><code class="java">
   * interface Person {
   ...
   * </code></pre>
   *
   * Mockito will return the vararg array if the given {@code position} targets the vararg index in
   * the method and if the return type has the same type as the vararg array.
   *
   * <pre class="code"><code class="java">
   * interface Person {
   ...
   * might have some side effects. Therefore you should use the doReturn|Throw|Answer|CallRealMethod

...
/**
 * Equivalent to {@link MockitoRule}, but inherits a different JUnit4 base interface {@link
 * TestRule}. For more information, please see the documentation on {@link MockitoRule}.
 *
 * @since 3.3.0
 */

...
public class MockitoHamcrest {
  ...
  /**
   * Enables integrating hamcrest matchers that match primitive <code>boolean</code> arguments. Note
   * that {@link #argThat} will not work with primitive <code>boolean</code> matchers due to <code>
   * NullPointerException</code> auto-unboxing caveat.
   *
   * <p>See examples in javadoc for {@link MockitoHamcrest} class
   *
  ...
  /**
   * Enables integrating hamcrest matchers that match primitive <code>double</code> arguments. Note
   * that {@link #argThat} will not work with primitive <code>double</code> matchers due to <code>
   * NullPointerException</code> auto-unboxing caveat.
   *
   * <p>* See examples in javadoc for {@link MockitoHamcrest} class
   *

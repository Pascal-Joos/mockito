 ...
 *
 * <ul>
 *   <li>an {@link OngoingInjector} that do nothing if a candidate couldn't be found
 *   <li>an {@link OngoingInjector} that will try to inject the candidate trying first the property
 *       setter then if not possible try the field access
 * </ul>
 */

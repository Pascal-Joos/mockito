...
public abstract class MockInjectionStrategy {
   ...
   *
   * <p>The implementation should take care of the actual calling if required.
   *
   ...
   *
   * <p>Actual algorithm is defined in the implementations of {@link #processInjection(Field,
   * Object, Set)}. However if injection occurred successfully, the process should return <code>true
   * </code>, and <code>false</code> otherwise.
   *
   * <p>The code takes care of calling the next strategy if available and if of course if required
   *
   ...
   *
   * <p>Don't call this method directly, instead call {@link #process(Field, Object, Set)}
   *

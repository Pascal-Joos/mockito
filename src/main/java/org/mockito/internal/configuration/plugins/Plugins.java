...
public class Plugins {
   ...
   *
   * <p>Returns default member accessor if no {@link org.mockito.plugins.MemberAccessor} extension
   * exists or is visible in the current classpath.
   */
   ...
   * {@link org.mockito.plugins.InstantiatorProvider2} extension exists or is visible in the current
   * classpath.
   */
   ...
   * org.mockito.plugins.AnnotationEngine} extension exists or is visible in the current classpath.
   */

...
public class LenientCopyTool {
    ...
    public <T> void copyToMock(T from, @Nullable T mock) {
    ...
    private <T> void copy(T from, @Nullable T to, Class<?> fromClazz) {
    ...
    private <T> void copyValues(T from, @Nullable T mock, Class<?> classFrom) {

...
public class GenericTypeExtractor {
   ...
   * interface. Examples:
   *
   * <p>1. Foo implements IFoo[Integer]: genericTypeOf(Foo.class, Object.class, IFoo.class) returns
   * Integer
   *
   * <p>2. Foo extends BaseFoo[String]: genericTypeOf(Foo.class, BaseFoo.class, IFoo.class) returns
   * String
   *

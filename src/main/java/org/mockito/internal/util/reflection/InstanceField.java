 ...
 *
 * <p>Contains the instance reference on which the field can be read and write.
 */
public class InstanceField {
   ...
   *
   * @param field The field that should be accessed, note that no checks are performed to ensure the
   *     field belong to this instance class.

...
public class InvocationsFinder {
    ...
    @NullUnmarked public static Invocation findFirstMatchingUnverifiedInvocation(
    ...
    @NullUnmarked public static Invocation findSimilarInvocation(
            List<Invocation> invocations, MatchableInvocation wanted) {
    ...
    @NullUnmarked public static Invocation findFirstUnverified(List<Invocation> invocations) {
        return findFirstUnverified(invocations, null);
    }

    @NullUnmarked static Invocation findFirstUnverified(List<Invocation> invocations, Object mock) {
    ...
    @NullUnmarked public static Location getLastLocation(List<Invocation> invocations) {
    ...
    @NullUnmarked public static Invocation findPreviousVerifiedInOrder(
     ...
     */
    @NullUnmarked public static Invocation findFirstUnverifiedInOrder(

...
public class TypeSafeMatching implements ArgumentMatcherAction {
  ...
  /**
   * Returns <code>true</code> if the given <b>argument</b> can be passed to the given <code>
   * argumentMatcher</code> without causing a {@link ClassCastException}.
   */
  ...
  /**
   * Returns the type of {@link ArgumentMatcher#matches(Object)} of the given {@link
  ...
  /** Returns <code>true</code> if the given method is {@link ArgumentMatcher#matches(Object)} */

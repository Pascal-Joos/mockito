...
public class StubbingLookupNotifier {
    ...
    public static void notifyStubbedAnswerLookup(Invocation invocation, @Nullable Stubbing stubbingFound, Collection<Stubbing> allStubbings, CreationSettings creationSettings) {
    ...
    static class Event implements StubbingLookupEvent {
        ...
        public Event(Invocation invocation, @Nullable Stubbing stubbing, Collection<Stubbing> allStubbings, MockCreationSettings mockSettings) {

...
class SubclassBytecodeGenerator implements BytecodeGenerator {
  ...
  public <T> Class<? extends T> mockClass(MockFeatures<T> features) {
    ...
    String typeName;
    if (localMock
        || loader instanceof MultipleParentClassLoader && !isComingFromJDK(features.mockedType)) {
      typeName = features.mockedType.getName();
    } else {
      typeName =
          InjectionBase.class.getPackage().getName() + "." + features.mockedType.getSimpleName();
    }

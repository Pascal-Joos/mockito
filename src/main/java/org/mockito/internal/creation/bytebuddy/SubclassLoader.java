...
/**
 * A subclass loader is responsible for resolving a class loading strategy for a mock that is
...
public interface SubclassLoader {
   ...
   *
   * @return {@code true} if this loader is not constraint to a target module being opened for
   *     loading a class.
   */
   ...
   * @param localMock {@code true} if the mock is loaded within the runtime package of the mocked
   *     type.

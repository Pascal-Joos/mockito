...
/**
 * Creates instances of Mockito JUnit Runner in a safe way, e.g. detecting inadequate version of
 * JUnit, etc.
 */
public class RunnerFactory {
   ...
   *
   * <p>TODO, let's try to apply Brice suggestion and use switch + Strictness
   */

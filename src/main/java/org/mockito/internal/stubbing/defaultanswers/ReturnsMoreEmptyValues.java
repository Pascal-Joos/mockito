 ...
 *
 * <p>Currently <b>used only</b> by {@link Mockito#RETURNS_SMART_NULLS}
 *
 * <p>Current version of Mockito mocks by default use {@link ReturnsEmptyValues}
 *
 * <ul>
 ...
 *       collection types)
 *   <li>Returns empty array for array-returning methods
 *   <li>Returns "" for String-returning method
 *   <li>Returns description of mock for toString() method
 *   <li>Returns non-zero for Comparable#compareTo(T other) method (see issue 184)

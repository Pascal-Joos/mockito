...
/**
 * This test is an experimental use of Mockito API to simulate static mocking. Other frameworks can
 * use it to build good support for static mocking. Keep in mind that clean code never needs to mock
 * static methods. This test is a documentation how it can be done using current public API of
 * Mockito. This test is not only an experiment it also provides coverage for some of the advanced
 * public API exposed for framework integrators.
 *
 * <p>For more rationale behind this experimental test <a
 * href="https://www.linkedin.com/pulse/mockito-vs-powermock-opinionated-dogmatic-static-mocking-faber">see
 * the article</a>.
 */
  ...
  public void verify_static_method() throws Throwable {
    ...
    Invocation invocation =
        Mockito.framework()
            ...
            .createInvocation(
                mock, withSettings().build(Foo.class), staticMethod, realMethod, "some arg");
    ...
    Invocation differentArg =
        Mockito.framework()
            .getInvocationFactory()
            .createInvocation(
                mock, withSettings().build(Foo.class), staticMethod, realMethod, "different arg");
  ...
  public void verification_failure_static_method() throws Throwable {
    ...
    Invocation invocation =
        Mockito.framework()
            .getInvocationFactory()
            .createInvocation(
                mock, withSettings().build(Foo.class), staticMethod, realMethod, "foo");
    handler.handle(invocation);
  ...
  public void stubbing_new() throws Throwable {
    ...
    Invocation differentArg =
        Mockito.framework()
            .getInvocationFactory()
            .createInvocation(
                mock, withSettings().build(Foo.class), adapter, realMethod, ctr, "different arg");

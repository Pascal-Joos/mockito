...
public class ExceptionFactoryTest {
  ...
  /**
   * loaded by the classloader {@value #classLoaderWithoutOpenTest}, which excludes OpenTest4J
   * classes
   */
  ...
  /**
   * loaded by the custom classloader {@value #classLoaderWithoutJUnitOrOpenTest}, which excludes
   * JUnit and OpenTest4J classes
   */
  ...
  public static void init() throws ClassNotFoundException {
    ...
    junit3ComparisonFailure =
        classLoaderWithoutOpenTest.loadClass(junit.framework.ComparisonFailure.class.getName());
    junit3ArgumentsAreDifferent =
        classLoaderWithoutOpenTest.loadClass(
            org.mockito.exceptions.verification.junit.ArgumentsAreDifferent.class.getName());
  ...
  private static AssertionError invokeFactoryThroughLoader(ClassLoader loader) throws Exception {
    ...
    Method m =
        exceptionFactory.getDeclaredMethod(
            "createArgumentsAreDifferentException", String.class, String.class, String.class);

...
public class ConstructorInstantiatorTest extends TestBase {
  ...
  public void creates_instances() {
    assertEquals(
        new ConstructorInstantiator(false, new Object[0]).newInstance(SomeClass.class).getClass(),
        SomeClass.class);
  }
  ...
  public void creates_instances_of_inner_classes() {
    assertEquals(
        new ConstructorInstantiator(true, this).newInstance(SomeInnerClass.class).getClass(),
  ...
  public void creates_instances_with_arguments() {
    assertEquals(
        new ConstructorInstantiator(false, "someString").newInstance(SomeClass2.class).getClass(),
        SomeClass2.class);
  }

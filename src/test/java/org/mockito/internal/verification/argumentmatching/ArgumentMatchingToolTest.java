...
public class ArgumentMatchingToolTest extends TestBase {
  ...
  public void shouldNotFindAnySuspiciousMatchersWhenNumberOfArgumentsDoesntMatch() {
    ...
    // when
    Integer[] suspicious =
        ArgumentMatchingTool.getSuspiciouslyNotMatchingArgsIndexes(matchers, new Object[] {10, 20});
  ...
  public void shouldUseMatchersSafely() {
    ...
    // when
    Integer[] suspicious =
        ArgumentMatchingTool.getSuspiciouslyNotMatchingArgsIndexes(matchers, new Object[] {10});

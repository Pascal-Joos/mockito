...
public class InvocationsFinderTest extends TestBase {
  ...
  public void setup() throws Exception {
    ...
    invocations.addAll(
        Arrays.asList(
            simpleMethodInvocation, simpleMethodInvocationTwo, differentMethodInvocation));
  }
  ...
  public void shouldFindFirstUnverifiedInOrder() throws Exception {
    ...
    assertSame(
        simpleMethodInvocation, InvocationsFinder.findFirstUnverifiedInOrder(context, invocations));
  ...
  public void shouldFindFirstUnverifiedInvocationOnMock() throws Exception {
    assertSame(
        simpleMethodInvocation,
        InvocationsFinder.findFirstUnverified(invocations, simpleMethodInvocation.getMock()));
  ...
  public void shouldReturnAllChunksWhenModeIsAtLeastOnce() throws Exception {
    ...
    Assertions.assertThat(chunk)
        .containsSequence(
            simpleMethodInvocation, simpleMethodInvocationTwo, simpleMethodInvocationThree);
  }
  ...
  public void shouldNotFindLocationsForEmptyInvocationsList() {
    Assertions.assertThat(InvocationsFinder.getAllLocations(Collections.<Invocation>emptyList()))
        .isEmpty();
  }
}

...
public class ReturnsSmartNullsTest extends TestBase {
  ...
  public void
    ...
    Object smartNull =
        answer.answer(
            invocationMethodWithArgs(new HashSet<String>(Arrays.asList("set-1", "set-2"))));
  ...
  private static <T> InterceptedInvocation invocationMethodWithVarArgs(final T[] obj)
    ...
    return new InterceptedInvocation(
        new MockStrongReference<Object>(mock(GenericFooBar.class), false),
        new SerializableMethod(
            GenericFooBar.class.getMethod("methodWithVarArgs", int.class, Object[].class)),
        new Object[] {1, obj},
        InterceptedInvocation.NO_OP,
        new LocationImpl(),
        1);
  ...
  public void
    ...
    Object smartNull =
        answer.answer(invocationMethodWithVarArgs(new Object[] {new Object() {}, new Object() {}}));

...
public class ObjectMethodsGuruTest extends TestBase {
  ...
  public void shouldKnowToStringMethod() throws Exception {
    ...
    assertFalse(
        ObjectMethodsGuru.isToStringMethod(IMethods.class.getMethod("toString", String.class)));
  ...
  public void shouldKnowCompareToMethod() throws Exception {
    ...
    assertFalse(
        ObjectMethodsGuru.isCompareToMethod(HasCompare.class.getMethod("foo", HasCompare.class)));
    assertFalse(
        ObjectMethodsGuru.isCompareToMethod(
            HasCompare.class.getMethod("compareTo", HasCompare.class, String.class)));
    assertFalse(
        ObjectMethodsGuru.isCompareToMethod(HasCompare.class.getMethod("compareTo", String.class)));
    assertFalse(
        ObjectMethodsGuru.isCompareToMethod(

...
public class GenericTypeExtractorTest extends TestBase {
  ...
  public void finds_generic_type() {
    ...
    assertEquals(
        String.class, genericTypeOf(new Base<String>() {}.getClass(), Base.class, IBase.class));
    assertEquals(
        String.class, genericTypeOf(new IBase<String>() {}.getClass(), Base.class, IBase.class));
    assertEquals(
        String.class,
        genericTypeOf(new StaticBase<String>() {}.getClass(), StaticBase.class, IBase.class));
    assertEquals(
        String.class,
        genericTypeOf(new StaticIBase<String>() {}.getClass(), Base.class, StaticIBase.class));

...
public class GenericMetadataSupportTest {
  ...
  public void can_resolve_type_variables_from_ancestors() throws Exception {
    ...
    assertThat(inferFrom(AnotherListOfNumbers.class).resolveGenericReturnType(listGet).rawType())
        .isEqualTo(Number.class);
    assertThat(
            inferFrom(AnotherListOfNumbersImpl.class).resolveGenericReturnType(listGet).rawType())
        .isEqualTo(Number.class);
  }
  ...
  public void can_get_type_variables_from_ParameterizedType() {
    assertThat(
            inferFrom(GenericsNest.class.getGenericInterfaces()[0]).actualTypeArguments().keySet())
        .hasSize(2)
        .extracting("name")
        .contains("K", "V");
    assertThat(
        ...
        .extracting("name")
        .contains("E");
    assertThat(inferFrom(Integer.class.getGenericInterfaces()[0]).actualTypeArguments().keySet())
        .hasSize(1)
        .extracting("name")
        .contains("T");
    assertThat(
            inferFrom(StringBuilder.class.getGenericInterfaces()[0]).actualTypeArguments().keySet())
        .isEmpty();
    assertThat(inferFrom(StringList.class).actualTypeArguments().keySet()).isEmpty();
  }
  ...
  public void
    ...
    GenericMetadataSupport genericMetadata =
        inferFrom(GenericsNest.class)
            .resolveGenericReturnType(firstNamedMethod("returningK", GenericsNest.class));
  ...
  public void
    ...
    GenericMetadataSupport genericMetadata =
        inferFrom(GenericsNest.class)
            .resolveGenericReturnType(
                firstNamedMethod("returning_wildcard_with_class_lower_bound", GenericsNest.class));
  ...
  public void
    ...
    GenericMetadataSupport genericMetadata =
        inferFrom(GenericsNest.class)
            .resolveGenericReturnType(
                firstNamedMethod(
                    "returning_wildcard_with_typeVar_lower_bound", GenericsNest.class));
  ...
  public void
    ...
    GenericMetadataSupport genericMetadata =
        inferFrom(GenericsNest.class)
            .resolveGenericReturnType(
                firstNamedMethod(
                    "returning_wildcard_with_typeVar_upper_bound", GenericsNest.class));
  ...
  public void can_extract_raw_type_from_bounds_on_terminal_typeVariable() {
    assertThat(
            inferFrom(OwningClassWithDeclaredUpperBounds.AbstractInner.class)
                .resolveGenericReturnType(
                    firstNamedMethod(
                        "generic", OwningClassWithDeclaredUpperBounds.AbstractInner.class))
                .rawType())
        .isEqualTo(List.class);
    assertThat(
            inferFrom(OwningClassWithNoDeclaredUpperBounds.AbstractInner.class)
                .resolveGenericReturnType(
                    firstNamedMethod(
                        "generic", OwningClassWithNoDeclaredUpperBounds.AbstractInner.class))
                .rawType())
  ...
  private Method firstNamedMethod(String methodName, Class<?> clazz) {
    ...
    throw new IllegalStateException(
        "The method : '" + methodName + "' do not exist in '" + clazz.getSimpleName() + "'");
  }
}

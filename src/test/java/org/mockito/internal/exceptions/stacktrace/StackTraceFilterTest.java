...
public class StackTraceFilterTest extends TestBase {
  ...
  public void shouldNotFilterOutTracesMiddleGoodTraces() {
    ...
    Assertions.assertThat(filtered)
        .has(
            onlyThoseClasses(
                "org.test.TestSupport", "org.test.TestSupport", "org.test.MockitoSampleTest"));
  }
  ...
  public void shouldKeepRunners() {
    ...
    Assertions.assertThat(filtered)
        .has(
            onlyThoseClasses(
                "org.test.MockitoSampleTest", "junit.stuff", "org.mockito.runners.Runner"));
  }
  ...
  public void
    ...
    Assertions.assertThat(filtered)
        .has(
            onlyThoseClasses(
                "org.test.MockitoSampleTest", "org.yet.another.good.Trace", "org.good.Trace"));
  }

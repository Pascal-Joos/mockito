 ...
 *
 * <p>Instances of this class are NOT thread safe (intentionally, they are not required to be thread
 * safe)
 *
 * <p>//TODO convert to test rule
 */
public class AsyncTesting {
  ...
  /**
   * Schedules execution of runnable with some delay. Starts thread immediately and returns. The
   * thread will execute the runnable after given delay in millis.
   *
  ...
  /**
   * Interrupts and waits for all threads to complete (using 'join()'). Rethrows exceptions
   * accumulated by the execution of threads.
   */
  public void cleanUp() {
    stopping = true;
    System.out.println(

...
public class Stopwatch {
  ...
  public void start() {
    if (startNanos != null) throw new IllegalStateException("This stop watch is already started!");
  ...
  private static void fail(String message, long expectedNanos, long elapsedNanos) {
    throw new MockitoAssertionError(
        format(message, NANOSECONDS.toMillis(expectedNanos), NANOSECONDS.toMillis(elapsedNanos)));
  }

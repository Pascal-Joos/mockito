...
public class TestBase {
  ...
  /**
   * Filters out unwanted line numbers from provided stack trace String. This is useful for writing
   * assertions for exception messages that contain line numbers.
   *

...
public class JUnitResultAssert {
  ...
  /**
   * @param expectedExceptions - failures must match the supplied sequence in order, if supplied
   *     input is empty, this method is a no-op
   */
  ...
  /**
   * Expects single failure with specific exception and exception message. Automatically filters
   * line numbers from exception messages.
   */

...
/**
 * Bridge method is generated by compiler when erasure in parent class is different. When is
 * different then it means that in runtime we will have overloading rather than overridding
 * Therefore the compiler generates bridge method in Subclass so that erasures are the same,
 * signatures of methods match and overridding is ON.
 */

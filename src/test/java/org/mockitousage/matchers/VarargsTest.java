...
public class VarargsTest {
  ...
  /**
   * Relates to Github issue #583 "ArgumentCaptor: NPE when an null array is passed to a varargs
   * method"
   */
  @Test
   ...
   *   <li>#565 ArgumentCaptor should be type aware' are fixed this test must succeed
   * </ul>
   */
  @Test

...
/**
 * This unit test lives in 'org.mockitousage' package for a reason. It makes it easy to write tests
 * that depend on the stack trace filtering logic. Long term, it would be nice to have more
 * configurability in TestBase to make it easy to write such unit tests in 'org.mockito.*' packages.
 */

...
public class StrictRunnerTest extends TestBase {
  ...
  public void succeeds_when_all_stubs_were_used() {
    ...
    Result result =
        runner.run(
            StubbingInConstructorUsed.class, StubbingInBeforeUsed.class, StubbingInTestUsed.class);
    // then
  ...
  public void fails_when_stubs_were_not_used() {
    Class[] tests = {
      StubbingInConstructorUnused.class, StubbingInBeforeUnused.class, StubbingInTestUnused.class
    };
